...
const buildOtpHtml = (otp) => `
  <div style="font-family: Outfit, Arial, sans-serif; max-width: 480px; margin: 0 auto;">
    ...
    <p style="color: #666; font-size: 14px;">This code expires in ${OTP_TTL_MINUTES} minutes. If you did not create an account, you can ignore this email.</p>
...
const sendOtpEmail = async (email, otp) => {
  ...
  await sgMail.send({
    ...
    text: `Your Mood Studios verification code is ${otp}. It expires in ${OTP_TTL_MINUTES} minutes.\n\nCan't find this email? Check your Spam or Promotions folder.`,
